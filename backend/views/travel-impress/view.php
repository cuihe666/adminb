...
<!--                                    <img src="--><?php //echo $v ?><!--" alt="">-->
                ...
                <textarea
                    style="width:65%;min-height:175px;margin-left:20px;float: left;background: #fff;padding:10px 5px;" readonly><?php echo str_replace("<br>","\n",$model->des); ?></textarea>
                <div style="clear:both;"></div>
                <span style="float: left;margin-left:51px;margin-top:20px;" class="tg_title">内容</span>
                <div class="contimg"
                     style="width:375px;margin-left:100px;background: #fff;padding:10px 5px;margin-top:25px;padding-left:6px;padding:0 15px;overflow-x: hidden; ">
                    <p class="div-sxh2">
...
//        $(".layer_con input").attr("src", this_src);
    ...
    $('.ajaxbtn').click(function () {
        ...
        layer.confirm('确认要进行此操作吗？', {icon: 3, title: '友情提示'}, function (index) {
            $.post("<?=Url::to(["travel-impress/check"])?>", {
                ...
                if (data == 1) {
                    ...
                    layer.alert('操作成功');
                    /*window.location.href = '<?php echo \yii\helpers\Url::to(['travel-impress/index']) ?>';*/
