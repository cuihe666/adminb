                    ...
                    <el-row  v-if="base_form.is_more == 1">
                        ...
                        <el-col :span="21" :md="21" :xs="21">
                            ...
                            <el-row v-for="(attr,pid) in attr_block" :class="[ pid==0 ? '' : 'row-top-40']">
                                <el-row :gutter="10">
                                    <el-col  :span="4" :lg="6" :md="8" :sm="10" :xs="12" class="col-top-5">
                                        <el-select v-model="attr_block[pid].value" @change="changeAttrValue(pid)" placeholder="请选择规格">
                                            <el-option v-for="item in spec_list" :key="item.value" :label="item.label" :value="item.value"></el-option>
                                        </el-select>
                                    </el-col>

                                    <!--新加规格输入框-->
                                    <el-col  :span="4" :lg="4" :md="6" :sm="8" :xs="10" class="col-top-5">
                                        <el-input v-model="attr_block[pid].child_new_value" @keyup.native.enter="addAttrChild(pid)" placeholder="请添加规格值"></el-input>
                                    </el-col>
                                    ...
                                    <el-col :span="4" :lg="6" :md="8" :sm="10" :xs="12" class="col-top-5">
                                        ...
                                        <el-tooltip class="item" effect="dark" content="添加规格值" placement="top-start">
                                            <el-button type="primary" icon="plus"  @click="addAttrChild(pid)"></el-button>
                                        </el-tooltip>
                                        <!--删除规格-->
                                        <el-tooltip class="item" effect="dark" content="删除规格" placement="top-start">
                                            <el-button type="danger" icon="delete" @click="delAttrValue(pid)"></el-button>
                                        </el-tooltip>
                                    </el-col>
                                </el-row>
                                ...
                                <el-row class="row-top-10">
                                    <el-col
                                        ...
                                        <el-button type="default" size="small">
                                            {{ child.label }}<i class="el-icon-close el-icon--right" @click="delAttrChild(pid,id)"></i>
                                        </el-button>
                                    </el-col>
                                </el-row>
                            </el-row>
                            ...
                            <el-row class="row-top-40">
                                <el-col :span="4">
                                    <el-button type="primary" icon="plus" v-if="attr_block.length < 3" @click="addAttrValue()">添加规格</el-button>
                                </el-col>
                            ...
                            <el-row class="row-top-40">
                                <el-col :span="24">
                                    ...
                                    <div style="margin-bottom: 20px" v-if="table_form.length != 0">
                                        <span>批量设置:</span>
                                        <el-button @click="openDialog('price','价格')">价格</el-button>
                                    ...
                                    <el-table
                                        ...
                                        <el-table-column
                                            ...
                                            <template scope="scope">
                                                <el-form-item class="row-top-20" label-width="0">
                                                    <el-input v-model.number="scope.row.price" placeholder="价格"></el-input>
                                                </el-form-item>
                                            </template>
                                        </el-table-column>
                                        ...
                                        <el-table-column
                                            ...
                                            <template scope="scope">
                                                <el-form-item class="row-top-20" label-width="0">
                                                    <el-input v-model.number="scope.row.stocks" placeholder="库存"></el-input>
                                                </el-form-item>
                                            </template>
                                        </el-table-column>
                ...
                <el-row>
                    <el-col :span="8" :md="8" :xs="24">
                        <el-form-item label="商品价格(元)" prop="price">
                            <el-input v-model="base_form.price" :disabled="base_form.is_more == '1'"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
...
<!--                                <el-input v-model="base_form.price"></el-input>-->
                            <el-upload
                            ...
                            <el-col :span="12" :md="12" :xs="24" >
                                <el-form-item label="商品品牌" >
                                    <el-select v-model="params_fix_block.brand" placeholder="请选择商品品牌">
                                        <el-option v-for="item in brand_list" :label="item.label" :value="item.value"></el-option>
                                    </el-select>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12" :md="12" :xs="24" >
                                <el-form-item label="上市时间" >
                                    <el-select v-model="params_fix_block.up_time" placeholder="请选择上市时间">
                                        <el-option v-for="item in up_time_list" :label="item.label" :value="item.value"></el-option>
                                    </el-select>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12" :md="12" :xs="24" >
                                <el-form-item label="产地" >
                                    <el-select v-model="params_fix_block.location" placeholder="请选择产地">
                                        <el-option v-for="item in local_list" :label="item.label" :value="item.value"></el-option>
                                    </el-select>
                                </el-form-item>
                            </el-col>
                                ...
                                <el-row :gutter="10" >
                                    <el-col :md="3" :xs="7" class="col-top-5">
                                        <el-form-item label-width="0" prop="extra_label">
                                            <el-input v-model="params_fix_block.extra_label" placeholder="参数名"></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :md="5" :xs="12" class="col-top-5">
                                        <el-form-item label-width="0" prop="extra_value">
                                            <el-input v-model="params_fix_block.extra_value" @keyup.native.enter="addParams()" placeholder="参数值"></el-input>
                                        </el-form-item>
                                    </el-col>
...
<!--                            <el-input v-model="base_form.description"></el-input>-->
                ...
                <el-row class="row-top-20">
                    <el-col :span="24" :md="24" :xs="24" >
                        <el-form-item label="包装清单" prop="packing_list">
                            <el-input type="textarea" v-model="base_form.packing_list" :autosize="{ minRows: 2, maxRows: 4}"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>
                    ...
                    <el-col :span="12" :md="8" :xs="24">
                        <el-form-item label="保修服务" >
                            <el-select v-model="base_form.warranty"  placeholder="请选择">
                                <el-option v-for="item in warranty_list"  :label="item.label" :value="item.value"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                </el-row>
    ...
    <el-dialog title="批量修改"  v-model="dialogFormVisible" size="tiny" close-on-press-escape="true" style="border-radius: 5px;">
...
//                console.log(table_data,title);
            ...
            console: function(){
                ...
                console.log('备选分类',this.default_category);
            },
            //打开批量修改模态框
...
//                    console.log('参数:'+key,'值:'+this.params_fix_block[key]);
                ...
                var _self = this;
//                console.log('提交的 base_form',this.base_form);
...
//                    this.lazySetCache('table_form',val);
                    if(this.base_form.is_more == '1'){
                        ...
                        for(index in val){
                            ...
                            if(index == 0){
                                lowest_price = parseInt(val[index].price);
                            }else{
                                if(val[index].price < lowest_price){
                                    lowest_price = val[index].price
                                }
                            }
                        }
//                        console.log('库存:'+ total_stocks,'价格:'+lowest_price);
                        this.base_form.price = lowest_price.toString();
