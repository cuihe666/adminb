...
?>
    ...
    <style>
        ...
        /*2017年5月10日14:03:45写滚动条展示不完全给日历加个宽度*/
        .hotel-form{
            width:100%;
        }
        .rummery_con{
    ...
    <div class="wrapper-content animated fadeInRight" style="background-color: #F2F2F2;">
        ...
        <section class="content">
            <ul class="rummery_tab clearfix">
                <li class="col-sm-8"><a href="<?php echo \yii\helpers\Url::to(['hotel/update','id'=>$_GET['hotel_id']]) ?>">酒店信息</a></li>
                <!-- 酒店2.1 添加酒店账户信息 ↓ admin:ys time:2017/11/3 -->
                <li class="col-sm-8"><a href="<?php echo \yii\helpers\Url::to(['hotel/hotel-account','id'=>$_GET['hotel_id']]) ?>">账号信息</a></li>
                <!-- 完 ↑ -->
                <li class="col-sm-8"><a href="<?php echo \yii\helpers\Url::to(['hotel/two','id'=>$_GET['hotel_id']]) ?>">酒店政策</a></li>
                <li class="col-sm-8"><a href="<?php echo \yii\helpers\Url::to(['hotel/three','id'=>$_GET['hotel_id']]) ?>">服务设施</a></li>
                <li class="col-sm-8"><a href="<?php echo \yii\helpers\Url::to(['hotel/four','id'=>$_GET['hotel_id']]) ?>">房型管理</a></li>
                <li class="col-sm-8 current"><a href="###">房态房价设置</a></li>
                <li class="col-sm-8"><a href="<?php echo \yii\helpers\Url::to(['hotel/hotel-pic','id'=>$_GET['hotel_id']]) ?>">图片管理</a></li>
                <li class="col-sm-8"><a href="<?php echo \yii\helpers\Url::to(['hotel/supplier','id'=>$_GET['hotel_id']]) ?>">关联供应商</a></li>
                <li class="col-sm-8"><a href="<?php echo \yii\helpers\Url::to(['hotel/contact','id'=>$_GET['hotel_id']]) ?>">联系人信息</a></li>
            </ul>
            ...
            <div class="rummery_con">
                <div class="rummery_item rummery_price">
                    <ul class="house_price_tab">
                        <a class="" href="<?php echo \yii\helpers\Url::to(['hotel/set-price','hotel_id'=>$_GET['hotel_id']]); ?>">房态</a>
                        <a class="current" href="<?php echo \yii\helpers\Url::to(['hotel/set-price1','hotel_id'=>$_GET['hotel_id']]); ?>">房价</a>
                    </ul>
                    <div class="house_price_con">
                        <!--房型-->
                        <div class="house_price_item fangxing">
                            <div class="house_top clearfix">
                                <div class="house_change fl">
<!--                                    <select name="fangxing_select">-->
...
<!--                                    </select>-->
                                ...
                                <div class="change_cal fr">
                                    <div class="price_clk price_clk_fangjia" data-toggle="modal" data-target="#more_modal_price">批量修改房价
                                    </div>
                                </div>
                            </div>
                            <div class="calender_con">
                                <div class="calender_right" style="padding-right: 244px;">
                                    <button class="oldprev2">&lt; 前9天</button>
                                    <div class="iDate2 date2">
                                        <span>选择日期</span>
                                        <input type="text" id="date_text2"
                                               value="<?php echo $_SESSION['hotel_price_' . $_GET['hotel_id']] ? $_SESSION['hotel_price_' . $_GET['hotel_id']] : date('Y-m-d'); ?>"
                                            ...
                                            <?php foreach ($v['date'] as $kk => $vv): ?>
                                                <div class="click_con po_re">
                                                    ...
                                                    <div class="dijia_input clk_ipt" style="display: none;">
                                                        <input type="number" class="hotel_price" id="" min="0"
                ...
                <div class="modal-body">
                    <ul class="house_modal_con">
                        ...
                        <li class="num clearfix">
                            ...
                            <div class="radio_box fl"><input type="radio" name="house_num_single" value="0" class="single_no_num fl"  checked="checked" /><span
                                    class="fl">不做修改</span></div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="house_modal_con">
                        ...
                        <li class="num clearfix">
                            <label for="" class="fl">可售数量：</label>
                            <div class="radio_box fl"><input type="radio" name="house_num" value="0" class=" no fl"  checked="checked" /><span
                                    class="fl">不做修改</span></div>
                            <div class="radio_box fl"><input type="radio" name="house_num" value="1" class="fl"/><span
                                ...
                                <div class="more_num_box fl"><em class="more_house_reduce fl">-</em>
                                    <input type="text" name="stock" class="fl" value="1" autocomplete="off"
                                           onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"
                                           onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"/><em
                                        class="single_house_add fl">+</em></div>
                                <span class="fl">间</span></div>
                    ...
                    <ul class="house_modal_con">
                        <li class="house_names clearfix">
                            ...
                            <div class="checkbox_box fl">
                                <input type="checkbox" value="<?php echo $v['id']; ?>" name="house_name_price" class="fl"/>
...
<!--                                <input type="radio" name="house_status_price" value="1" class="djyj fl"/>-->
                                <span class="fl">底价</span><input type="text" class="fl" name="tg_dj" style="width:60px;max-width: 60px;border: 1px solid #ccc;margin:4px;"/>
                                <span class="fl">佣金</span><input type="text" name="tg_yj" style="width:60px;max-width: 60px;border: 1px solid #ccc;margin:4px;">%
                            </div>
                        </li>
    ...
    <script src="<?= Yii::$app->request->baseUrl ?>/dist/js/calendar2.js"></script>
...
//            2017年5月4日15:11:17 zjl bug id 2148 end
            ...
            $('.date_text').change(function () {
                ...
                $.ajax({
                    type: 'post',
                    url: "<?php echo \yii\helpers\Url::to(['update-session1']) ?>",
                    data: {
                        hotel_id: hotel_id,
                        date: value,
                    },
