...
<script>
    ...
    var data = {
        ...
        ruleForm: {
            id:'<?= isset($insurance_info["id"])?$insurance_info["id"]:""?>',
            name: '<?= isset($insurance_info["name"])?$insurance_info["name"]:""?>',
            address:'<?= isset($insurance_info["address"])?$insurance_info["address"]:""?>',
            pic: '',
            type:'<?= isset($insurance_info["insurance_genre"])?$insurance_info["insurance_genre"]:""?>',
            contacts:'<?= isset($insurance_info["contacts"])?$insurance_info["contacts"]:""?>',
            contacts_phone:'<?= isset($insurance_info["contacts_phone"])?$insurance_info["contacts_phone"]:""?>'
            ...
            submitForm: function (formName) {
                ...
                this.$refs[formName].validate(function (valid) {
                    if (valid) {
                        ...
                        var postUrl = '/plane-insurance/reset';
...
//                            console.log(res.data);return;
                            if (res.data == 'success') {
                                layer.alert('操作成功');
                                window.location.href = '<?php echo \yii\helpers\Url::to(['plane-insurance/index'])?>';
                            } else {
