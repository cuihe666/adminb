...
<head>
	...
	<script type="text/javascript" src="<?= Yii::$app->request->baseUrl ?>/zcoperation/js/custorm/hot_edit.js"></script>
		...
		<div class="conts clear">
			...
			<table class="table table-bordered">
				<thead>
					...
					<td style="width: 10%" class="td2">跳转类型</td>
					<td style="width: 25%" class="td4">预览</td>
					<td style="width: 10%" class="td5">位置排序</td>
