...
<head>
	...
	<script type="text/javascript" src="<?= Yii::$app->request->baseUrl ?>/zcoperation/js/custorm/recommend_edit.js"></script>
		...
		<div class="conts clear">
			...
			<table class="table table-bordered">
				<thead>
					...
					<td style="width: 10%" class="td3">产品ID</td>
					<td style="width: 25%" class="td4">预览</td>
					<td style="width: 10%" class="td5">排序位置</td>
