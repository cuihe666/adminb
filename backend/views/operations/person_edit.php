...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= Yii::$app->request->baseUrl ?>/zcoperation/css/person_edit.css">
...
<div class="col-xs-12 col-sm-12 col-mg-12 main star_edit">
	...
	<div class="conts clear person_edit">
		<p class="add_new">
			...
			<a href="#"  class="btn btn-primary"  data-toggle="modal" onclick="addPerson()"><span class="glyphicon glyphicon-plus" style="margin-right: 6px"></span>新增</a>
		</p>
...
<div class="modal fade" id="myModal_add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="cont clear  person_confirm">
				<p class="common">
					<span class="tit">标题:</span>
					<input type="text" placeholder="请填写标题" name="" class="personTitle">
				</p>

				<p class="clear common">
					<span class="tit">跳转类型:</span>
					<select class="myLinkType"  id="mylinkType">
...
<!--						<option value="14">原生酒店</option>-->
				...
				<p  class="normal common">
					<span class="tit"></span>
					<input type="text" name="" class="link_url">
				</p>

				<p  class="travel common">
					<span class="tit"></span>
					<select class="myLinkType2"  id="travelType">
...
<!--						<option value="5">当地向导</option>-->
					...
					<input type="text" name="" class="travelInput2" placeholder="请填写产品id">
				</p>

				<p  class="travelCity common">
					<span class="tit"></span>
					<select class="myLinkType_long"  id="longTravelType">
						<option value="1">主题线路</option>
						<option value="2">当地活动</option>
<!--						<option value="4">游记攻略</option>-->
<!--						<option value="3">印象随笔</option>-->
<!--						<option value="5">当地向导</option>-->
			...
			<div class="modal-footer">
				<span style="margin-right: 100px;color: white;"  type="button"   class="btn btn-default  sureBtn updateStar edit" onclick=" _editPerson()" >确定</span>
				<span style="margin-right: 100px;color: white;"  type="button"  class="updateStar sureBtn add" onclick=" _addPerson()" >确定</span>
...
<script type="text/javascript" src="<?= Yii::$app->request->baseUrl ?>/zcoperation/js/custorm/person_edit.js"></script>
</body>
</html>