...
<script>
    ...
    var data = {
        ...
        ruleForm: {
            ...
            pic: '',
            commission:'',//固定佣金
            collection_method: '0',//佣金收取方式
            goods_id:'',//产品ID
            commission_note: true,//固定佣金显示标记
            ratio_note: false//佣金比例显示标记
        },
        pic_num: 0,
        pic_name:'',
        ...
        methods: {
            submitForm: function (formName) {
                ...
                this.$refs[formName].validate(function (valid) {
                    if (valid) {
                        var postUrl = '/insurance-manage/add';
                        ...
                        postData.append('ratio', _self.ruleForm.ratio);//佣金比例
...
//                            console.log(res.data);return;
            ...
            resetForm: function(formName) {
                location.href="<?= \yii\helpers\Url::to(['insurance-manage/index'])?>";
            },
...
//                const isPNG = file.type === 'image/png'
                ...
                if (!isLt2M) {
                    layer.msg('上传文档大小不能超过 2MB!', {time:2000});
                    return false;
                }
