...
$default_goods = \backend\controllers\ShopBannerController::getEditGoods($model->goods_id);
...
<script>
    ...
    var data = {
        ...
        ruleForm: {
            bid: '<?php echo $model->id ?>',
            name: '<?php echo $model->title ?>',
            pic: '',
            is_index: '<?php echo $model->is_home ?>',
            type: ' <?php echo $model->type ?>',
            category: '',
            goods_id: '<?php echo $model->goods_id ?>',
            sort: <?php echo $model->sort?>,
        },
    ...
    var app = new Vue({
        ...
        mounted: function () {
            ...
            this.img_list_desc = [{
                name: 'food.jpeg',
                url: '<?php echo $model->img_url ?>'
            }];
            this.ruleForm.pic = '<?php echo $model->img_url ?>'
            ...
            submitForm: function (formName) {
                ...
                this.$refs[formName].validate(function (valid) {
                    if (valid) {
                        ...
                        var postUrl = '/shop-banner/edit';
                        var postData = new FormData();
                        postData.append('id', _self.ruleForm.bid);
