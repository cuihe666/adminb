                    ...
                    <div class="ibox-content" style="margin-bottom: 20px;">
                        <div class="search-box clearfix">
                            <div class="search-item">
                                <?= Html::beginForm(['travel-higo/index'], 'get', ['enctype' => 'multipart/form-data', 'class' => 'form-horizontal', 'id' => 'addForm']) ?>
                                <div class="search-item">
                                ...
                                <div class="search-item">
                                    <div class="input-group" style="width: 110px; float: left;margin-right: 10px;">
                                        <?= Html::activeInput('text', $searchModel, 'scity', ['class' => 'form-control input', 'placeholder' => '按出发城市']) ?>
                                    </div>
                                </div>
                                <div class="search-item">
                                    <div class="input-group" style="width: 110px; float: left;margin-right: 10px;">
                                        <?= Html::activeInput('text', $searchModel, 'ecity', ['class' => 'form-control input', 'placeholder' => '按结束城市']) ?>
                                    </div>
                                </div>
                                <div class="search-item">
                                ...
                                <div class="search-item">
                                    <div class="input-group" style="width: 110px; float: left;margin-right: 10px;">
                                        <?= Html::activeDropDownList($searchModel, 'identity', [0 => '公司', 1 => '个人'], ['class' => 'form-control', 'prompt' => '按性质']) ?>
                                    </div>
                                </div>
                                <div class="search-item">
                                    <div class="input-group" style="width: 120px; float: left;margin-right: 10px;">
                                ...
                                <div class="search-item">
                                    <div class="input-group"  style="width: 110px; float: left;margin-right: 10px;">
                                        ...
                                        <?= Html::a("清空",$url = ['travel-higo/index'],$options = ['class' => 'btn btn-sm btn-primary']) ?>
                                    </div>
                                </div>
                                <?= Html::endForm() ?>
                            </div>
                        ...
                        $gridColumns = [
                            ...
                            ['attribute' => 'account',
                                ...
                                'value' => function ($model) {
                                    //2017年6月23日16:04:47   付燕飞加判断。如果$model->uid不为空的时候再调用下面获取账号名称的方法。
                                    if($model->uid) {
                            ...
                            ['attribute' => 'identity',
                                ...
                                'value' => function ($model) {
                                    ...
                                    if($model->uid) {
                                        switch ($model->identity) {
                                            case 0;
                                                return Yii::$app->params['group_type'][\backend\models\TravelCompany::getCompany($model->uid)['group_type']];
                                                break;
                                            case 1;
                                                return "--" ;
                                                break;
...
//                                        $Idents = \backend\models\TravelActivity::getIdentUrl($model->uid);
                                        ...
                                        if ($Idents['auth'] == 1 && $Idents['status'] == 0 && $model->status == 0) {
                                            return Html::a('审核', ['travel-higo/view', 'id' => $key], ['class' => 'btn btn-info']) . '&nbsp;' . Html::a('资质审核', ['travel-person/view', 'id' => $Idents['id']], ['class' => 'btn btn-info']);
                                        }

                                        if ($Idents['auth'] == 2 && $Idents['status'] == 0 && $model->status == 0) {
                                            return Html::a('审核', ['travel-higo/view', 'id' => $key], ['class' => 'btn btn-info']) . '&nbsp;' . Html::a('资质审核', ['travel-company/view', 'id' => $Idents['id']], ['class' => 'btn btn-info']);
                                        }

                                        //-------------------2017年6月23日16:45:12     付燕飞 增加 当企业信息或者个人信息资料未完善的时候  资质审核那显示资质待完善，不能点击
                                        if ($Idents['auth'] == 1 && $Idents['status'] == 3 && $model->status == 0) {
                                            return Html::a('审核', ['travel-higo/view', 'id' => $key], ['class' => 'btn btn-info']) . '&nbsp;' . Html::a('资质待完善', ['travel-person/view', 'id' => $Idents['id']], ['class' => 'btn btn-default disabled']);
                                        }

                                        if ($Idents['auth'] == 2 && $Idents['status'] == 3 && $model->status == 0) {
                                            return Html::a('审核', ['travel-higo/view', 'id' => $key], ['class' => 'btn btn-info']) . '&nbsp;' . Html::a('资质待完善', ['travel-company/view', 'id' => $Idents['id']], ['class' => 'btn btn-default disabled']);
                                        }
                                        //-------------------结束

                                        if ($Idents['auth'] == 1 && $Idents['status'] == 1 && $model->status == 0) {
                                            return Html::a('审核', ['travel-higo/view', 'id' => $key], ['class' => 'btn btn-info']);
                                        }
                                        ...
                                        if ($Idents['auth'] == 1 && $Idents['status'] == 0 && $model->status == 1) {
                                            return Html::a('查看', ['travel-higo/view', 'id' => $key], ['class' => 'btn btn-info']) . '&nbsp;' . Html::a('资质审核', ['travel-person/view', 'id' => $Idents['id']], ['class' => 'btn btn-info']);
                                        }
                                        ...
                                        if ($Idents['auth'] == 2 && $Idents['status'] == 0 && $model->status == 1) {
                                            return Html::a('查看', ['travel-higo/view', 'id' => $key], ['class' => 'btn btn-info']) . '&nbsp;' . Html::a('资质审核', ['travel-company/view', 'id' => $Idents['id']], ['class' => 'btn btn-info']);
                                        }
                                        ...
                                        if ($Idents['status'] == 1 && $model->status == 1) {
                                            return Html::a('下线', "javascript:drop($key);", ['class' => 'btn btn-danger', 'id' => $key]) . Html::a('查看', ['travel-higo/view', 'id' => $key], ['class' => 'btn btn-info']);
                                        }


                                        if ($Idents['status'] == 1 && $model->status == 2) {
                                            return Html::a('上线', "javascript:online($key);", ['class' => 'btn btn-danger', 'id' => $key]) . Html::a('查看', ['travel-higo/view', 'id' => $key], ['class' => 'btn btn-info']);
                                        }
