...
<html lang="en">
<head>
    <title>财务管理-退款管理-旅行-待退款订单-退款待审核</title>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <u style="color:orange" data-toggle="modal" data-target="#myModal5">¥200.00</u>
                        </td>
                        <td>
                            实收金额：
                        </td>
            ...
            <div class="modal-footer footer-btn">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal3">确认退款</button>
                <button type="button" class="btn btn-default" data-toggle="modal" data-target="#myModal4">拒绝退款</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body h-body">
                <p>拒绝退款后，结果将不可更改，您确定吗？</p>
                <textarea id="" cols="30" rows="10" placeholder="备注"></textarea>
            </div>
            <div class="modal-footer footer-btn">
                <button type="button" class="btn btn-primary">确定</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
            ...
            <div class="form_table">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>退款中</td>
                        <td>
                            <button style="color:#3c8dbc" data-toggle="modal" data-target="#myModal2">退款审核</button>
