...
<html lang="en">
<head>
    <title>财务管理-对账处理-收款单管理-收款单列表</title>
    ...
    <script src="<?= Yii::$app->request->baseUrl ?>/webcaiwu/js/dz_skd_list.js"></script>
...
<div class="sxh_main">
    ...
    <section class="content-header h_wrap">
        <ul id="flagTab">
            <li class="current-top" status="">全部</li>
            <li status="1">待处理</li>
        </ul>
        <hr>
    </section>
        ...
        <div class="sxh_tk-cx">
            <div class="sxh_content">
                ...
                <ul class="first_ul">
                    <li>
                        <span>收款单号：</span>
                        <input type="text" class="sk_number" value="">
                    </li>
                    <li>
                        <span>订单编号：</span>
                        <input type="number" class="dd_number" value="">
                    </li>
                    <li>
                        <span>商品ID：</span>
                        <input type="number" class="sp_number" value="">
                    </li>
                    <li>
                        <span>收款单类型：</span>
                        <select name="" id="skdType">
                            <option value="">全部</option>
                            <option value="1">国内民宿应收</option>
                            <option value="2">海外民宿应收</option>
                            <option value="3">旅行应收</option>
                            <option value="4">旅行退款应收</option>
                        </select>
                    </li>
                    <li>
