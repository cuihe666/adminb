            ...
            <div class="form_table">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>已结算未打款</td>
                        <td>
                            <button style="color:#3c8dbc" data-toggle="modal" data-target="#myModal">确认退款</button>
                            <button style="color:#3c8dbc" data-toggle="modal" data-target="#myModal2">退款驳回</button>
                            <a href="#">查看</a>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <button style="color:#3c8dbc" data-toggle="modal" data-target="#myModal">确认退款</button>
                            <button style="color:#3c8dbc" data-toggle="modal" data-target="#myModal2">退款驳回</button>
                            <button style="color:#3c8dbc" data-toggle="modal" data-target="#myModal3">商家已退款</button>
                            <a href="#">查看</a>
                        </td>
                    </tr>
                    </tbody>
