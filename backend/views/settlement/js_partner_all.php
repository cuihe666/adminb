...
<html lang="en">
<head>
    <title>财务管理-结算处理-合伙人结算-合伙人待付款-全部</title>
...
<div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" style="width: 400px;margin-left: 120px;">
            ...
            <div class="modal-body" style="text-align: center;">请选择所要导出的订单</div>
            <div class="modal-footer" style="text-align: center;">
                <button type="button" class="btn confirm1" data-dismiss="modal" style="margin-right: 80px;background: #1888F8;color: white;">确定</button>
...
<div class="sxh_main">
    ...
    <section class="content-header h_wrap">
        <ul class="tit_btn">
            ...
            <li class="current-top" index="" style="background: white;border: 1px solid #666;">
                <a style="color: black;">
                    全部 <i></i>
                </a>
            </li>
            ...
            <div class="sxh_content">
                ...
                <ul class="first_ul">
                    ...
                    <li>
                        ...
                        <input id="date_start" name="" placeholder="请选择开始时间" value="" class="Wdate" type="text" onfocus="var date_end=$dp.$('date_end');WdatePicker({readOnly:true,onpicked:function(){date_end.focus()}})" />至
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>
                            ...
                            <span style="display: inline-block">合伙人信息</span>
                        </td>
                        <td>
                            <span>收款方式</span>
                        </td>
...
<!--                    </tr>-->
            ...
            <div class="paganition">
                <div class="left">
                    <span>每页显示条数:</span>
                    <select style="width: 70px;" class="pageSize">
                ...
                <div class="right">
                    <ul class="pager">
                        ...
                        <li style="margin-left: 20px;">跳转到&nbsp;<input type="text" class="to_page" style="width: 40px;padding-left: 5px;"  value="1"/>&nbsp;页<button class="turn_pages" style="margin-left: 10px;padding: 4px 8px;color: white;background: #367fa9;">确定</button></li>
                    </ul>
                </div>
