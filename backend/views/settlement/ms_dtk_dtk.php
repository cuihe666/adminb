...
<head>
    ...
    <title>财务管理-退款管理-民宿-待退款订单-待退款</title>
    ...
    <script src="<?= Yii::$app->request->baseUrl ?>/webcaiwu/js/ms_dtk_dtk.js"></script>
                ...
                <div class="search-content">
                    <ul class="first_ul">
                        ...
                        <li>
                            ...
                            <input id="date_start" name=""  placeholder="请选择开始时间" value="" class="Wdate" type="text" onfocus="var date_end=$dp.$('date_end');WdatePicker({readOnly:true,onpicked:function(){date_end.focus()}})" />-
