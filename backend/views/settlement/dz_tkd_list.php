...
<html lang="en">
<head>
    <title>财务管理-对账处理-退款单管理-退款单列表</title>
    ...
    <script src="<?= Yii::$app->request->baseUrl ?>/webcaiwu/js/dz_tkd_list.js"></script>
        ...
        <div class="sxh_tk-cx">
            <div class="sxh_content">
                ...
                <ul class="first_ul">
                    <li>
                        <span>退款单号：</span>
                        <input type="text" id="tk_number" value="">
                    </li>
                    <li>
                        <span>订单编号：</span>
                        <input type="number" id="dd_number" value="">
                    </li>
                    <li>
                        <span>收款单号：</span>
                    ...
                    <li>
                        <span>商品ID：</span>
                        <input type="number" id="sp_number" value="">
                    </li>
                    ...
                    <li>
                        ...
                        <input id="date_end" class="Wdate" name="" value="" placeholder="请选择结束时间" type="text" onFocus="WdatePicker({minDate:'#F{$dp.$D(\'date_start\',{d:+1})}',readOnly:true})" />
                    </li>
                    <li>
                        <span>退款单状态：</span>
                        <select id="tk_state">
                    ...
                    <li>
                        <span>退款单类型：</span>
                        <select name="" id="tk_lei">
                            <option value="">全部</option>
                            <option value="1">民宿应退</option>
                            <option value="2">旅行应退</option>
                        </select>
                    </li>
                    <li>
