...
<head>
    <script type="text/javascript">
        ...
        // 点击拒绝退款清空textarea reject()
        function reject(){
            $("#m_textarea").val("");
        }
    </script>
    <title>财务管理-退款管理-民宿-待退款订单-全部</title>
    ...
    <script src="<?= Yii::$app->request->baseUrl ?>/webcaiwu/js/ms_dtk_all.js"></script>
            ...
            <div class="modal-body"  style="height: 400px; overflow: auto">
                <table class="table table-bordered js_pay">
                    ...
                    <tr>
                        ...
                        <td style="color:orange" class="amount_cw">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer footer-btn">
                <button type="button" class="btn btn-primary dtk_y">确定</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="myModa23" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer footer-btn">
                <button type="button" class="btn btn-primary dqr_tk">确定</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body h-body">
                <textarea name="" id="m_textarea" style="width: 100%;resize:none" placeholder="请输入拒绝理由" value=""></textarea>
            </div>
            <div class="modal-footer footer-btn">
                <button type="button" class="btn btn-primary dtk_n">确定</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
            </div>
        </div>
    </div>
...
<div class="sxh_main">
    ...
    <section class="content-header h_wrap">
        <ul>
            <li class="current-top">
                <a href="<?php echo \yii\helpers\Url::to(['settlement/ms_dtk_all']) ?>">
                    全部
                </a>
            </li>
            <li>
                <a href="<?php echo \yii\helpers\Url::to(['settlement/ms_dtk_dqr']) ?>">
                    退款待确认
                </a>
            </li>
            <li>
                <a href="<?php echo \yii\helpers\Url::to(['settlement/ms_dtk_dtk']) ?>">
                    待退款
                </a>
            </li>
        </ul>
    ...
    <!--                            <option value="0">不限</option>-->
                            ...
                            <input id="date_start" name="" value="" placeholder="请选择开始时间" class="Wdate" type="text" onfocus="var date_end=$dp.$('date_end');WdatePicker({readOnly:true,onpicked:function(){date_end.focus()}})" />-
    ...
    <!--                <div style="clear:both;"></div>-->
            ...
            <div class="paganition">
                <input type="hidden" value="1" class="page_hid" />
                <div class="left">
                    <span>每页显示条数:</span>
