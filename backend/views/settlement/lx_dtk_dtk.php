...
<html lang="en">
<head>
    <title>财务管理-退款管理-旅行-待退款订单-待退款</title>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer footer-btn">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal3">退款</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel4">退款成功:</h4>
            </div>
            <div class="modal-body">
                <table class="table table-bordered">
                    <tbody>
            ...
            <div class="form_table">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>退款中</td>
                        <td>
                            <button style="color:#3c8dbc" data-toggle="modal" data-target="#myModal2">退款</button>
