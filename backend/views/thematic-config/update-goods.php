            ...
            <div class="config_r fl">
                ...
                <div class="config_con config_color">
                    <?= Html::beginForm('', 'post', ['enctype' => 'multipart/form-data',"class"=>'activity_form']) ?>
                            ...
                            <div class="c_item c_bg">
                                ...
                                <div style="display: inline" class="goods_div">
                                    ...
                                    <span style="position:relative;display: inline-block;" class="keywords">
                                        ...
                                        <div class="auto-screening auto-hidden" id="autoScreening" style="display:none;position:absolute;left:0;top:35px;width:100%;border:1px solid #666;"></div>
                        ...
                        <div class="c_box c_bg_box goods_info">
                            <div class="c_item c_bg">
                                <span style="float: left;min-width: 80px;">商品主图</span>
                                <img src="<?=$goods_info['title_pic']?>" alt="" style="display:inline;width:200px;height:150px;" class="c_goods_img">
                            </div>
                        </div>
                        <div class="c_box c_btn_box goods_info" style="margin-bottom:50px;">
                            <div class="c_item c_btn">
                                <label for="" style="min-width: 80px;">商品名称</label>
                                <span class="c_goods_name"><?=$goods_info['name']?></span>
                            </div>
                        </div>
                        <div class="c_box c_btn_box goods_info" style="margin-bottom:50px;">
                            <div class="c_item c_btn">
                                <label for="" style="min-width: 80px;">商品价格</label>
                                <span class="c_goods_price"><?=$goods_info['price']?></span>元
                            </div>
                        </div>
                        <!--提交按钮-->
                        <div class="c_submit">
                            <input type="hidden" name="thematic_id" value="<?=$activity['id']?>">
                            <input type="hidden" name="goods_id" class="goods_id" value="<?=$goods_info['id']?>" />
                            ...
                            <button class="c_button button_sure button_goods">确定</button>
                        </div>
                    <?= Html::endForm();?>
                </div>
            </div>
