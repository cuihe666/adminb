    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body model_st">
                ...
                <div class="row row_model">
                    <span>时间:</span>
                    <input id="date_start" name="date_start" placeholder="上线时间" value="" class="Wdate" type="text"
                           onfocus="var date_end=$dp.$('date_end');WdatePicker({readOnly:true,minDate:'%y-%M-{%d}',onpicked:function(){date_end.focus()}})"
                    / >至
                    <input id="date_end" class="Wdate" name="date_end" placeholder="下线时间" value="" type="text"
                           onFocus="WdatePicker({minDate:'#F{$dp.$D(\'date_start\')}',readOnly:true,maxDate:'#F{$dp.$D(\'date_start\',{M:+6})}'})"/>
                    <i class="tips_time" style="color:red;font-size:12px;"></i>
                </div>
                <div class="row row_model">
                    <span>排序:</span>
...
<script>
    $('.obj_btn').click(function () {
        ...
        $.ajax({
            ...
            data: {cid: cid, title: title,desc:desc,type:type, num: num, pic: pic},
