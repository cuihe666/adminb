                    ...
                    <div class="ibox-content" style="margin-bottom: 20px;">
                        <div class="search-box clearfix">
                            <div class="search-item">
                                <?= Html::beginForm(['travel-higo-manage/index'], 'get', ['enctype' => 'multipart/form-data', 'class' => 'form-horizontal', 'id' => 'addForm']) ?>
                                <div class="search-item">
                                ...
                                <div class="search-item">
                                    <div class="input-group" style="width: 120px; float: left;margin-right: 10px;">
                                        <?= Html::activeInput('number', $searchModel, 'account', ['class' => 'form-control input', 'placeholder' => '发布账号',"onkeyup"=>"value=value.replace(/[^1234567890-]+/g,'')"]) ?>
                                    </div>
                                </div>
                                <div class="search-item">
                                ...
                                <div class="search-item" style="overflow:hidden;">
                                    <div class="input-group" style="width: 110px; float: left;">
                                        ...
                                        <?= Html::a("清空",$url = ['travel-higo-manage/index'],$options = ['class' => 'btn btn-sm btn-primary']) ?>
                                    </div>
                                </div>
                                <?= Html::endForm() ?>
                            </div>
                        ...
                        $gridColumns = [
                           ...
                           /* ['class' => 'yii\grid\SerialColumn',
                            ...
                            ['attribute' => 'start_city',
                                'header' => '出发城市',
                                'value' => function ($model) {
                                    return $model->startCityName->start_name;
                                }
                            ],
                            ['attribute' => 'end_city',
                                'header' => '目的地城市',
                                'value' => function ($model) {
                                    return $model->endCityName->end_name;
                                }
                            ],
                            ['attribute' => 'tag',
                                'header' => '主题标签',
...
<!--弹出框-->
                ...
                <div class="moda1_sort">
                    <div class="modal-body" style="overflow: hidden;">
                        ...
                        <p>
                            ...
                            <span class="higo_name"></span>
                        </p>
                        <p>
                            <label style="float: left">排序值：</label>
                            <input type="number" class="modal_text app_link higo_sort" name="higo_sort" value="0" oninput="if(value.length>1){value=10}" min="0" max="10" >
    ...
    <script>
        ...
        $(".f_sort").click(function(){
            ...
            $.ajax({
                type: 'post',
                url: "<?=Url::to(['travel-higo-manage/get-higo-info']) ?>",
                data: {
                    "higo_id":id,
                },
                success: function (data) {
                    data = eval("("+data+")");
                    $(".moda1_sort .higo_name").text(data.name)
                    $(".moda1_sort .higo_sort").val(data.sort);
        ...
        $(".m_commit").click(function(){
            ...
            $.post("<?=Url::to(["travel-higo-manage/update-sort"])?>", {
        ...
        $(".f_reject").click(function(){
            ...
            $(".moda1_reject").show();
            $("#more_modal").modal("show");
            $(".higo_name_r").text($(this).parents("tr").find("td").eq(6).text());
        ...
        $(".m_commit_r").click(function(){
            ...
            var higo_id = $(".moda1_reject .m_higo_id").val();
            if(m_reason==""){
                $(".m_reason_e").text("请填写驳回原因");
                return false;
            }
            $.post("<?=Url::to(["travel-higo-manage/update-status"])?>", {
                "PHPSESSID": "<?php echo session_id();?>",
                "<?=Yii::$app->request->csrfParam?>": "<?=Yii::$app->request->getCsrfToken()?>",
                data: {
                    "higo_id":higo_id,
