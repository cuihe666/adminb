...
<div class="booking-index">
    <ul class="title">
        <li class="on"><a href="<?=\yii\helpers\Url::to(['travel-tag-manage/higo'])?>">主题线路</a></li>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="overflow: hidden;">
                <h4 class="modal-title t_name" id="myLargeModalLabel"></h4>
                <p>
                    <label style="float: left">主题名称：</label>
...
//                            window.reload();
        ...
        $('.line').click(function(){//禁用
            ...
            $.ajax({
                type:'post',
                url:"<?=\yii\helpers\Url::toRoute(['travel-tag-manage/get-changes'])?>",
                ...
                success:function(data){
                    ...
                    if(data.status==-1){
                       ...
                       if(data.options.length!=0){
                           ...
                           layer.confirm("已有"+data.nums+"篇线路选择此标签，是否将已选标签替换：<select name='change_item' class='change_item'>"+return_data+"</select><p>禁用后此标签在商家后台和APP端将不再显示，确定禁用吗？</p>", {icon: 3, title: '友情提示'}, function (index) {
