...
<div class="booking-index">
    <ul class="title">
        ...
        <li class="on"><a href="<?=\yii\helpers\Url::to(['travel-tag-manage/impress'])?>">印象</a></li>
                ...
                success: function (data) {
                    ...
                    if(data.status==-1){
                        ...
                        if(data.options.length!=0){
                            ...
                            layer.confirm("已有"+data.nums+"篇印象选择此标签，是否将已选标签替换：<select name='change_item' class='change_item'>"+return_data+"</select><p>禁用后此标签在商家后台和APP端将不再显示，确定禁用吗？</p>", {icon: 3, title: '友情提示'}, function (index) {
...
//
            ...
            if(status == '1'){
//                console.log(status+'44');return false;
