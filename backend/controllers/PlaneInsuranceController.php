 ...
 */
class PlaneInsuranceController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    public function actionIndex()
    {
        ...
        $searchModel['insurance_note'] = 'insurance';
    ...
    public function actionAdd()
    {
        if (Yii::$app->request->isPost) {
            ...
            try{
                ...
                $errMap = [
                    'insert_sql_abnormal' => 'insert_sql_abnormal',
     ...
     * @供应商上线操作
     */
    public function actionUpInsuranceStatus()
    {
     ...
     * @供应商下线操作
     */
    public function actionLowInsuranceStatus()
    {
        if (Yii::$app->request->isAjax) {
            $id = Yii::$app->request->post('data')['id'];
            $update_data = [
