...
class Uploader
{
     ...
     */
    public function __construct($fileField, $config,$params, $type = "upload")
    {
        $this->fileField = $fileField;
        $this->config = $config;
        $this->type = $type;
        $this->params = $params;   //$_GET（即为前台页面传递过来的参数值）     2017年3月23日10:58:24付燕飞新增加的参数
    ...
    private function upFile()
    {
        ...
        $key = $this->params['filename']."-".$this->params['kaid']."-".time().rand(100000,999999).$this->fileType;
