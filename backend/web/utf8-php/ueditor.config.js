...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
            ...
            'simpleupload', 'insertimage', 'emotion',  'insertvideo', 'map', 'gmap', 'insertframe', 'insertcode', 'webapp', 'pagebreak', 'template', 'background', '|',
            'horizontal', 'date', 'time', 'spechars', 'snapscreen', 'wordimage', '|',
            'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', 'charts', '|',
            'print', 'preview', 'searchreplace', 'drafts', 'help'
        ]]
		//,imagePath:"http://img.tgljweb.com"
		//,savePath: ['imgs']
        //
		//,filePath:"http://img.tgljweb.com"
		//,imageManagerPath:"http://img.tgljweb.com"
