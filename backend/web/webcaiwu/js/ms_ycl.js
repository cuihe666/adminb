                    ...
                    if(res.pageInfo.list.length == 0){
                        ...
                        $("#export_all").on("click", function(){
                            ...
                            $("#myModa33 .confirm").on("click", function() {
                                $("#myModa33").modal("hide");
                                var all_url = http_url + export_init + "?orderType=5";
                                // console.log(all_url)
                        ...
                        // 点击价格显示日期
                        $(".datePrice").on("click", function(){
                            var pay_url = "/api/order/house/refundorders/";
                            var pay_id = $(".datePrice").parent().parent().find("input").eq(0).val();
                            // console.log(pay_url + pay_id)
                        })
                        // 点击操作里面的按钮执行
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(res){
                                                if(res.code == 0){
                                                    ...
                                                    $(".js_pay td").eq(33).html(res.data.refundOrder.overManFee);
